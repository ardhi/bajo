...
class Bajo extends Plugin {
  ...
  formatByField = (field, value, dataType, options = {}) => {
    ...
    const setting = defaultsDeep(options.formatter[dataType], this.config.intl.formatter[dataType])
  ...
  format = (value, type, options = {}) => {
    ...
    if (['integer', 'smallint', 'float', 'double'].includes(type)) {
      ...
      const setting = defaultsDeep(options.formatter[type], intl.formatter[type])
