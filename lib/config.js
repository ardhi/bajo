 ...
 * @property {string} [intl.emptyValue=''] - Value to use for empty values. Default is empty string
 * @property {Object} [intl.datetime] - Datetime format. See {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat|Intl.DateTimeFormat} for more information
 * @property {Object} [intl.date] - Date format. See {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat|Intl.DateTimeFormat} for more information
 * @property {Object} [intl.time] - Time format. See {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat|Intl.DateTimeFormat} for more information
 * @property {Object} [intl.float] - Float format. See {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat|Intl.NumberFormat} for more information
 * @property {Object} [intl.double] - Double format. See {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat|Intl.NumberFormat} for more information
 * @property {Object} [intl.smallint] - Smallint format. See {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat|Intl.NumberFormat} for more information
 * @property {Object} [intl.integer] - Integer format. See {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat|Intl.NumberFormat} for more information
 ...
 * @property {string} [intl.timeZone] - Default timezone for internationalization. If not provided, the system timezone will be used
...
const config = {
  ...
  lang: Intl.DateTimeFormat().resolvedOptions().locale ?? 'en-US', // should we change to 'locale' instead of 'lang'?
  intl: {
    supported: ['en-US', 'id'],
    fallback: 'en-US',
    lookupOrder: [],
